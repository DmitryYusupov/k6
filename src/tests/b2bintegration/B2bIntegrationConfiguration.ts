...
export const B2B_INTEGRATION_URL = "http://mci-dzo-b2b-integration.test.dzo.vp.sbc.dc"
//export const B2B_INTEGRATION_URL = "http://localhost:8098"
export const B2B_INTEGRATION_SUB_PATH_PATCH_VIDEO = "/api/v1/content/video"
export const B2B_INTEGRATION_SUB_PATH_SEARCH_VIDEO = "/api/v1/content/video/search"
export const B2B_INTEGRATION_SUB_PATH_SEARCH_PLAY_LIST = "/api/v1/content/playlist/search"
...
export const B2b_TEST_DURATION = "1s"
